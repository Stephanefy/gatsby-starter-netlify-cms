...
<ul style={{marginTop:'1rem'}}>
  <li>- Les documents obligatoires concernant les différents cursus de formation (traditionnelle, AAC ou conduite supervisée)</li>
  <li>- Les compétences à maîtriser et à valider lors de la formation</li>
</ul>
...
<ul style={{marginTop:'1rem'}} className="is-size-6">
    ...
    <li>- Réaliser deux manœuvres différentes, dont une au moins en marche arrière
</li>
    <li>- Procéder à la vérification d’un élément technique à l’intérieur ou à l’extérieur du véhicule, répondre à une question en lien avec la sécurité routière et à une question portant sur les notions élémentaires de premiers secours
</li>
    <li>- Appliquer les règles du code de la route et les prescriptions relatives aux jeunes conducteurs
</li>
    <li></li>
    <li>- Adopter une conduite économie en carburant et limitant les rejets de gaz à effet de serre
</li>
...
Cette évaluation consiste en un bilan des compétences nécessaires et fondamentales devant être acquises pour une conduite en sécurité.
L’expert s’attache à valoriser les acquis comportementaux plutôt que les faiblesses. Il réalise ainsi un inventaire des points positifs et des points négatifs restitués par rapport à une compétence donnée.<br/>
Un échange entre l’expert retranscrit de façon formelle ce bilan de compétences dans une grille d’évaluation.
...
Le formateur, présent le jour de l’évaluation, pourra expliquer à l’élève les différentes notes obtenues et les commentaires de l’expert, ce qui permet en cas d’échec de savoir quels sont les points à travailler et à améliorer.
       ...
       <Steps direction="vertical" size="large" current={this.state.current} onChange={this.onChange}>
...
" description="" />
                <Step title="La présentation de l’épreuve par l’examinateur ;
" description="" />
                <Step title="L’installation au poste de conduite ;
" description="" />
                <Step title="Les réglages du véhicule nécessaires avant le départ et réalisés par le candidat ;
" description="" />
                <Step title="Une phrase de conduite effective d’une durée minimale de 25 minutes ;
" description="" />
                <Step title="La réalisation d’un test de la vue ;
" description="" />
                <Step title="La réalisation de deux manœuvres particulières à tester en relation avec la sécurité routière (un freinage pour s’arrêter avec précision et une manœuvre en marche arrière) ;
" description="" />
                <Step title="Des questions portant notamment sur la vérification d’un élément technique en relation avec la sécurité routière, à l’intérieur et à l’extérieur du véhicule ;
" description="" />
                <Step title="La mise en action d’un accessoire ou commande d’accessoire en cours de circulation ;
" description="" />
                <Step title="L’établissement du certificat d’examen du permis de conduire CEPC
" description="" />
            </Steps>
              </div>
            </div>
