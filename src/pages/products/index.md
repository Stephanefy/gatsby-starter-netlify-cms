...
code pricing:
  plans:
    - plan: Code 3 mois
      ...
      items:
        - 3 mois de code
        - Frais d'accompagnement à l'examen
      description: formule simple code
  heading: Formules Code
  description: Trois formules adaptées à l'apprentissage du code de la route
main:
