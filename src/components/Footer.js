        ...
        <div className="content has-text-centered block" data-sal='zoom-in' data-sal-duration='200ms'>
          ...
          <div className="columns is-centered" >
            <div className="column is-half">
              ...
              Depuis sa création en 1979 l'auto école Sainte Clotilde assure une formation de qualité. Une équipe dynamique, compétente et sérieuse vous accompagne et se tient à votre disposition grâce à son expérience depuis plus de 25 ans.
              </p>
            </div>
          </div>
        </div>
