      ...
      <section className="section">
        ...
        <div className="columns mx-4">
          ...
          <p className="column is-10 is-size-4 has-text-centered">
            ...
            la route et d’adapter son comportement à toute situation. C’est
            pourquoi l’examen du code de la route comporte dix thématiques, et
            chacune d’entre elles doit être parfaitement connue du candidat.
          </p>
          <div className="column"></div>
        </div>
        ...
        <h2 className="is-size-2 has-text-centered">
          Déroulement de l'éxamen théorique général
        </h2>
        <div className="columns my-6">
          ...
          <div className="column is-10">
            ...
            >
              <Step
                title="L'inscription"
                description="Votre auto auto-école se charge de tout l’aspect administratif de votre inscription. L’examen du code de la route vous est facturé 30€ par le centre d’examen agréé que vous aurez choisi qui correspond à la redevance*.
...
En plus de la redevance, l’auto l’auto-école se réserve le droit de facturer aux candidats des frais d’accompagnement"
              ...
              <Step
                ...
                description="Vous présentez votre pièce d’identité ainsi que votre convocation ;
...
Vos résultats vous sont communiqués par mail, sous 48h"
              ...
              <Step
                ...
                description={
                  <div>
                    <p>
                      Chacune des questions posées le jour de l’examen aborde
                      l’un des 9 thèmes de la structure du code de la route :
                    </p>
                    <ul>
              ...
              <Step
                title="Les résultats"
                description="Vous avez obtenu une note supérieure ou égale à 35/40 ? BRAVO ! Vous avez réussi votre examen du code de la route et pouvez dès à présent vous lancer dans votre formation à la conduite.
